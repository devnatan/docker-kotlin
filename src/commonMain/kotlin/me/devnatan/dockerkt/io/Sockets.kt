...
internal const val TcpSocketPrefix = "tcp://"
internal const val HttpSocketPrefix = "http://"

// unix:///var/run/docker.sock
public const val DefaultDockerUnixSocket: String = "$UnixSocketPrefix/var/run/docker.sock"

// tcp://localhost:2375
public const val DefaultDockerHttpSocket: String = "${TcpSocketPrefix}localhost:$DockerSocketPort"
